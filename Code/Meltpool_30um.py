...
X_train, X_test, Y_train, Y_test = np.load('./2021_30ms_128.npy', allow_pickle = True)
print(X_train.shape)
...
model.save('./model/30ms_model.h5', overwrite=True)
...
caltech_dir = "D:/FILE/meltpool_img/TEST_30"
image_w = 128
image_h = 128
