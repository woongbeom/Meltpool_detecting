...
X_train, X_test, Y_train, Y_test = np.load('./2021_100ms_128.npy', allow_pickle = True)
print(X_train.shape)
...
model.save('./model/100ms_model.h5', overwrite=True)
...
model = load_model('./model/100ms_model.h5')
model.compile(loss='categorical_crossentropy', optimizer='RMSprop', metrics=['accuracy'])


caltech_dir = "D:/FILE/meltpool_img/TEST_100"
image_w = 128
image_h = 128
